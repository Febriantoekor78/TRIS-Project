                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										<?php
											$mission_query = mysql_query("select * from content where title  = 'misi' ")or die(mysql_error());
											$mission_row = mysql_fetch_array($mission_query);
											echo $mission_row['content'];
										?>
								<hr>
										<?php
											$vision_query = mysql_query("select * from content where title  = 'visi' ")or die(mysql_error());
